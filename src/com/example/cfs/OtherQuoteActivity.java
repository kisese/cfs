...
public class OtherQuoteActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		url_string = "http://www.callfast.co.ke/index.php/2014-03-27-01-51-51/other-callfast-services-quote-request";
	...
	private class DisplayWebViewTask extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(OtherQuoteActivity.this);
